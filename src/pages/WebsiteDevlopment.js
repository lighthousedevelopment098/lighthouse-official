...
const WebsiteDevlopment = () => {
    ...
    return (
        <>
            <HeroSection style={style} heading={<><h1><span className="greenBackground">Website</span> Devlopment</h1></>} subHeading='" Cloud Servers lightning speed"' animationData={webDevlopment} />
            <TechnologyStack />
            <AreYouReady />
            <DigitalRealities />
            <TheBestTimeToStart />
