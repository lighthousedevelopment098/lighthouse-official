...
//             bg1={bg1}
//             heading={<>
//                 <h1 className=' font-bold heroHeading'>Think <span className="greenBackground">Ahead</span> & </h1>
//                 <h1 className='heroHeading'><span className='greenBackground text-white'>Scale</span> Results</h1></> } 
